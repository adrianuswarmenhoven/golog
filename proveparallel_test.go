...
func TestFactsParallel(t *testing.T) {
	...
	*/
	...
	solutions = m.ProveAllParallel(`parent(Name).`)
	if len(solutions) != 3 {
		t.Errorf("Wrong number of solutions: %d vs 3", len(solutions))
...
func TestConjunctionParallel(t *testing.T) {
	m := NewMachine().Consult(`
        floor_wax(briwax).
        floor_wax(shimmer).
        floor_wax(minwax).
...
func TestCutParallel(t *testing.T) {
	m := NewMachine().Consult(`
        single(foo) :-
            !.
        single(bar).
...
func TestAppendParallel(t *testing.T) {
	m := NewMachine().Consult(`
...
func TestUnifyParallel(t *testing.T) {
	m := NewMachine().Consult(`
        thing(Z) :-
            Z = whatever.
        two(X, Y) :-
...
func TestDisjunctionParallel(t *testing.T) {
	m := NewMachine().Consult(`
        insect(fly).
        arachnid(spider).
        squash(Critter) :-
...
func TestIfThenElseParallel(t *testing.T) {
	m := NewMachine().Consult(`
        succeeds(yes).
        succeeds(yup).
...
func TestNotWithCutParallel(t *testing.T) {
	m := NewMachine()
...
func TestCanProveOnceParallel(t *testing.T) {
	counter := 0
